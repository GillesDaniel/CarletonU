...
/*-- prod
	...
	@SCANNMAX_PSWD VARCHAR(60) = '0xA4D25FA14A299F91BA1AAE5E92D8EB334041FEB85D60E05E36296EE80BFB74A1',
	@SCANNMAX_URL VARCHAR(250) = 'https://www.scannmax.ca/';
	*/
--new dev
	@ENVIRONMENT_NAME VARCHAR(30) = 'Test',
	@DUMMY_DOMAIN VARCHAR(100) = '@dummy.cumtn',
	@DUMMY_FAX VARCHAR(20) = '1-800-555-5555',
	@WEBAPPURL VARCHAR(1024),
	@URL VARCHAR(1024),
	@HOSTNAME VARCHAR(1024) = 'maxtest.carleton.ca', 
	@GLOBALDIR VARCHAR(1024) = '/opt/IBM/maximomif',
	@DBSERVERHOSTNAME VARCHAR(1024) = 'CUMTN-MAXDEVSQL', 
	@SMP_DIR VARCHAR(1024) = '/opt/IBM/SMP', 
	@TEMP_LOGS VARCHAR(1024) = '/opt/IBM/logs', 
	@HTTP_DOCUMENT_ROOT VARCHAR(1024) = '/opt/IBM/DOCLINKS', 
	@DOC_PATH VARCHAR(1024) = '/opt/IBM/DOCLINKS', 
	@SCANNMAX_PSWD VARCHAR(60) = '0xE79C31CFA677919BB79521B78E6F757D339637CE24DF7199766DEA4FE7E30AFCC7BB5903CFC3DAC1',
...
update MAXPROPVALUE set PROPVALUE='https://'+@HOSTNAME+'/maximo/oslc' where PROPNAME='mxe.oslc.webappurl';
...
update maxpropvalue set propvalue = @SCANNMAX_PSWD where propname='scannmax.client.password' -- update ScanNmax Password
