const resourceNoNameItem = {
  member: [
      ...
      skdresourcedispview: [
        {
          ...
          shiftnum: 'DAY',
          start: '2023-08-20T14:00:00+00:00',
          end: '2023-08-21T14:00:00+00:00',
          duration: 2,
          assignment: [
            {
              wostatus_maxvalue: 'INPRG',
              wopriority: 2,
              description: 'Exhaust leak',
              worktype: 'CM',
              wonum: 'BSTB1226',
              address: '1251 Balmoral Street',
              fnlconstraint: '2023-08-22T14:00:00+00:00',
            },
          ],
        },
      ],
    ...
    },
    {
      ...
      initialized: false,
      utilization: 40,
      href: 'oslc/os/mxapiskdproject/_R0FOQVQxLzEwMTE-/SKDRESOURCE/4',
      shiftnum: 'DAY',
...
export default resourceNoNameItem;
