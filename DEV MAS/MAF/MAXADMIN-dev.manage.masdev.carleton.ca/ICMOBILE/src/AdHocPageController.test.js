...
it('Load page, goto detail page, and go back.', async () => {
  ...
  controller.onBeforeLoadData(adhocInvBalanceAllListds);
  ...
  adHocPage.state.shouldLoadAll = true;
  adHocPage.state.allitems.length = 0;
  adhocInvBalanceAllListds2.dataAdapter.totalCount = 10;
  app.state.loadcount = 0;
  controller.onAfterLoadData(adhocInvBalanceAllListds2, [1]);
