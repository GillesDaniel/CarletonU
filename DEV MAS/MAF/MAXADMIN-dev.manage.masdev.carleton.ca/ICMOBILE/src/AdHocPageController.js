...
class AdHocPageController {
  ...
  async setUpInitialDataSource(){
    ...
    await this.getAllItemsFromDataSource(adhocAllDataResource, false);
  ...
  */
  async getAllItemsFromDataSource(datasource, forceSync) {
    ...
    // for all loaded case, all items loaded, initializeItemsOnTab4Adhoc won't be called in onAfterLoadData
    // istanbul ignore else
    if (allLoaded) {
  ...
  async updatePhyscnt(args){
    ...
    if(this.app.state.adhocds === "mxapiinvbalds_json"){
      ...
      let mxapiinvbalds_json = this.page.findDatasource("mxapiinvbalds_json");
      let mxapiinvbaldscounted_json = this.page.findDatasource("mxapiinvbaldscounted_json");

      await mxapiinvbalds_json.deleteItem(args);
      await mxapiinvbaldscounted_json.add(args);
    ...
    this.page.state.needsetup = false;  
  ...
  async reloadDatasource(){
    ...
    await this.getAllItemsFromDataSource(adhocAllDataResource, true);
  }
