...
* IBM Corp.
--%><%@ page import="java.util.*,psdi.webclient.system.runtime.*,psdi.webclient.system.session.*,psdi.util.*,psdi.server.*"                 
%>
<%
...
<%
//Set mxe.importJspAccess = true to use the import page
String access = MXServer.getMXServer().getProperty("mxe.importJspAccess",false);
if (access==null) {
	access = "false";
}
