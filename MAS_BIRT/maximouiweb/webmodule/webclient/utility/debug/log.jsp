...
%><%
	...
	if(action != null)
	{
		action = HTML.securitySafeWithHTMLEncoding(action);
		...
		else if(action.equals("set"))
		{
			...
			if (attr != null)
				attr = HTML.securitySafeWithHTMLEncoding(attr);
				
			String value = request.getParameter("value");
			if (value != null)
				value = HTML.securitySafeWithHTMLEncoding(value);
			...
			else if(attr.equals("level"))
			{
				...
				if(categoryName != null) {
					categoryName = HTML.securitySafeWithHTMLEncoding(categoryName);
