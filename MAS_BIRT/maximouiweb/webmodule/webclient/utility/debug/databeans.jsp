...
%><%
	...
	if (properties != null)
		properties = HTML.securitySafeWithHTMLEncoding(properties);
		
	String mboset = request.getParameter("mboset");
	if (mboset != null)
		mboset = HTML.securitySafeWithHTMLEncoding(mboset);
	...
	if (Boolean.parseBoolean(properties))
	{
		...
		if (beanId != null)
			beanId = HTML.securitySafeWithHTMLEncoding(request.getParameter("beanId"));
		JSONArray items = null;
		if(beanId != null)
		{
	...
	else if (Boolean.parseBoolean(mboset))
	{
		// Data for mboset in grid
		String beanId = request.getParameter("beanId");
		if (beanId != null)
			beanId = HTML.securitySafeWithHTMLEncoding(beanId);
		JSONArray items = null;
		if(beanId != null)
		{
	...
	else
	{
		...
		String snapshotTemp = request.getParameter("snapshot");
		if (snapshotTemp != null)
			snapshotTemp = HTML.securitySafeWithHTMLEncoding(snapshotTemp);
		boolean snapshot = Boolean.parseBoolean(snapshotTemp);
