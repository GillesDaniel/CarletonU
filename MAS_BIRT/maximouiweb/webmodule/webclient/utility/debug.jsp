...
%><%
	...
	if (dev != null)
		dev = HTML.securitySafeWithHTMLEncoding(request.getParameter(dev));
...
<script data-dojo-config="async: true<%if(dev!=null){%>, packages:[{name:'ibm', location:'../../ibm' }]<%}%>"
		src="../javascript/<%=dojoDirectory%>/dojo/dojo.js<%if(dev!=null){%>.uncompressed.js<%}%>"
