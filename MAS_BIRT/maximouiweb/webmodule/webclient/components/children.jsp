...
--%><%@ include file="../common/simpleheader.jsp" %><%
	...
	if(children!= null && children.size() > 0)
	{
		...
		if(firstChild != null && firstChild instanceof psdi.webclient.controls.SectionHeader) {
			fullWidth = true;	
		}	
	...
	if(!width.equals(""))
	{
		styleWidth = "width:"+width+((fullWidth)?" !important":"")+";";
		width="width=\""+width+"\"";
	}
	...
	if(!height.equals(""))
	{
		...
		//height = "height=\"" + component.getWebClientSession().removeUOM(height) + "\"";
		...
		else
		{
			...
			while (i.hasNext())
			{
				...
				if(child.getType().equals(renderControls))
				{
					...
					child.setFocusable(control.isFocusable());
					child.render();
				}
			}
		}
