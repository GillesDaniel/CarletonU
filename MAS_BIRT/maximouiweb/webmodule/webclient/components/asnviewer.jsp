...
<%
	...
	String ILOG_VIEWER_APPLET_ID = "ASNViewerId";
	String ILOG_VIEWER_APPLET_DIV = "asnViewerAppletDiv";	
	String ILOG_VIEWER_LOADING_ID = "asnviewer_loading"; 
	String ILOG_VIEWER_TABLE = "asnviewertable";
