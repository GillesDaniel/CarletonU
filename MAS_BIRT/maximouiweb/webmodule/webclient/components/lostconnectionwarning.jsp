...
<%if(debug){%><!-- Begin LOST CONNECTION WARNING DIALOG --><%}%><%
													...
													<tr>
														<td align="<%=reverseAlign%>" nowrap="nowrap">
															<div id="warnlcdiv_okbutton" nowrap="nowrap" needsrefresh="false" vis="true" class="bc" style="display:none;">
																<button type="button" control="true" style="" class="text pb default" onclick="parent.handleLostconnectionWarnDialog('close')">
																&nbsp;&nbsp;<%=oklbl %>&nbsp;&nbsp; 
																</button>
															</div>
														</td>
