...
%>		<div id="canvas_iframe_div" style="border:1px solid #CCCCCC; width: <%=width%>px; height: <%=height%>px; overflow: auto;" <%=iframeAutomationId%> align="<%=defaultAlign%>" valign="middle" >
...
<%	if (!app.getId().equalsIgnoreCase("designer"))
	...
	{ 
		...
		designAppURL = base + "/ui/maximo.jsp?event=loadapp&targetid=" + designApp + "&value=" + designApp
				+ "&designmode=true"+designAppDebug+"&"+wcs.getUISessionUrlParameter();
