			...
			<td valign="BOTTOM" style="padding:0px;" class="dh mh dhb">
				<table id="warndiv_content0" width="100%" role="presentation">
					<tr>
						...
						<%	if (!uiskin) {	%>
						<td align="<%=reverseAlign%>" class="" valign="middle" style="padding:0px;" width="100%" nowrap="nowrap">
							<div nowrap="nowrap" needsrefresh="false" vis="true" class="bc" style="display:inline;"><img tabindex="0" border="0" onclick="handleWarnDialog('close')" onkeydown="if(hasKeyCode(event,'KEYCODE_SPACEBAR|KEYCODE_ENTER')){handleWarnDialog('close');}" tabindex='0' class="" src="dialogclose.gif" style="cursor:default;display:block;margin:0px" align="<%=reverseAlign%>" alt="" ></div>
						</td>
						<%	}	%>
					</tr>
				</table>
				...
				<table class="dialogb" width="100%" style="position:relative;top:0px;margin:0px;" height="100%" role="presentation">
					<tr>
						<td class="" style=";padding:0px;">
							...
							<img tabindex="0" alt="" role="presentation" onfocus="moveable_onfocus(this);" src="<%=IMAGE_PATH%>blank.gif" width="1" height="1" lastbuttonid="" aria-hidden="true"/>
						</td>
					</tr>
				</table>
			</td>
