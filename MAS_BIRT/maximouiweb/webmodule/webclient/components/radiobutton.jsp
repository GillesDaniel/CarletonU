...
%><input type="radio" name="<%=rbGroup.getRenderId()%>" tabindex="<%=rbGroup.getTabindex((psdi.webclient.controls.RadioButton)control)%>" ctype="radiobutton"<%
	...
	{
		%> aria-readonly="true" aria-disabled="true"  <%if(!accessibilityMode){%>disabled="disabled"<%}%><%
	}
