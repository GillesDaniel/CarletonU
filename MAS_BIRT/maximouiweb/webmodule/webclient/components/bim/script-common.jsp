<%--
* Copyright IBM Corporation 2009,2024-2017
*
...
/**********************************************************************/
	...
	function placeViewerInt( elem, targ )
	{
		...
		if( f != null && f != undefined && f.id == "<%=ctrlId%>" )
		{
			...
			//console.log(">>> resize ctrlId!! 3", f.style.height, f.style.width);
		}
	...
	function resizeCtrl(passVar) {
		//console.log(">>> script-common resizeCtrl 1");
		if(passVar["height"] && passVar["width"]) {
		//console.log(">>> script-common resizeCtrl 2");
			var ctrl = document.getElementById("<%=ctrlId%>");
			if(ctrl) {
		...
		//console.log(">>> script-common resizeCtrl 3", passVar.height, passVar.width);
		//console.log(">>> script-common resizeCtrl 4", parseInt(passVar.height, 10), parseInt(passVar.width, 10));
		//console.log(">>> script-common resizeCtrl 5", "<%=viewer_height_offset%>", "<%=viewer_width_offset%>");
		//console.log(">>> script-common resizeCtrl 6", ctrl.style.height, ctrl.style.width);
			}
		}
	}
