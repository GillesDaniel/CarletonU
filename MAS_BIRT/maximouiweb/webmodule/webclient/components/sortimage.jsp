...
--%><%@ include file="../common/componentheader.jsp" %><%
	...
	String ariaHidden = " aria-hidden='true' ";
...
%><img id="<%=id%>" <%=automationId%> tabindex="-1" border="0"<%=ariaHidden%>src="<%=IMAGE_PATH%><%=src%>" aria-live="polite" alt="<%=msg%>" width="<%=width%>" height="<%=height%>" align="absmiddle" style="margin:0px;" <%=componentEvents%> /><%
	if(!sortLevel.equals("")) {
	%><%=sortLevel%></span><%	
	} %>
