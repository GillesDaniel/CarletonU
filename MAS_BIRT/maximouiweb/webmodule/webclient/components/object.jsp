...
%>	
		<table aria-hidden="true" align="<%=defaultAlign%>" align="center" WIDTH="<%=width%>" HEIGHT="<%=height%>" control="true" controltype="wfcanvas" style="width:<%=width%>px;height:<%=height%>px;position:relative;top:-5000px;" >
			<tr>
