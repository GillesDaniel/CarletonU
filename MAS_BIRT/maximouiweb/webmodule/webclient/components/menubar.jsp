...
<%
// Advanced Search and Save Query buttons (querytoolbar) need to be rendered for single page apps e.g., VIEWSR
Boolean querytoolbar = control.getId().equalsIgnoreCase("querytoolbar");

if(ismobile || querytoolbar || (!control.getProperty("event").equals("search") && !control.getProperty("sourcemethod").equals("getAppSearchOptions"))) {
...
<%		return;
	...
	String ariaLabel = control.getProperty("label");
...
%>	<ul aria-label="<%=ariaLabel%>" class="menubar" role="toolbar" data-type="<%=control.getType()%>">
<%
