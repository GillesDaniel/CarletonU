...
--%><%@ include file="../common/simpleheader.jsp" %><%
	...
	String visible = component.getProperty("visible");
	if(morehelp.length() > 0)
	{
		try
		{
			morehelp = morehelp.replace("../webclient/images/", "");
	...
	if(!WebClientRuntime.isNull(innerhtml)){
		innerhtml = innerhtml.replace("../webclient/images/", "");
	}
	String opacityCss = "";
	String displayMode = "";
...
<div width="100%" class="helpgrid <%=opacityCss%>">
	<table border="0" width="100%" summary="" <%=displayMode%> id="<%=id%>" <%=automationId%> role="presentation">
		<tr>
			<td width="1" valign="top">
				<img alt="" border="0" src="<%=IMAGE_PATH%><%if(langcode.equalsIgnoreCase("HE")){%>../<%}%>icon_details.gif" role="presentation"/>
			</td>
