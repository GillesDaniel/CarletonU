...
--%><%
    ...
    String moreInfo = "<a href='{0}' target='help' > "+wcs.getMessage("jspmessages", "morehelp")+"</a>";     

%><script>
	//supported data types
	var CS_VALIDATE_OK_LABEL = "<%=wcs.getMessage("messagebox","MSG_BTNOK")%>";
    var MORE_INFO = "<%=moreInfo%>";
    var MOREHELP_URL = "<%=WebClientRuntime.getWebClientRuntime().getHelpUrl("com.ibm.support.mbs.doc", "messages/{0}.html", "")%>"
