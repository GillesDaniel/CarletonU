		...
		jsonEditorOptions: function() {
            var options = {
	    	    ...
	    	    onUpdate: function () {
	      	    ...
	      	    onRestore: function () {
	      	    	var thisObj = this;
	      	    	thisJEObjectObj.ask("linearasset#restoredefaultsymbology").then(function (reply) {
	    	    ...
	    	    onHelp: function () {
	    	    	try {
	    	    		thisJEObjectObj.sendMaximoEvent("lvcSymbologyInfo", "", thisJEObjectObj.componentId);
	    	    	} catch (err) {
	    	    ...
	    	    showGraph: function () {
	    	    	try {
	    	    		thisJEObjectObj.sendMaximoEvent("lvcJSONGraph", "", thisJEObjectObj.componentId);
	    	    	} catch (err) {
	    	    		console.error('Failed: lvcJSONGraph', err);
	    	    	}
	    	    }
            };
