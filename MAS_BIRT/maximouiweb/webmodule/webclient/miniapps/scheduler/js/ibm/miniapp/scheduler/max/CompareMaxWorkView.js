...
define([
    ...
    return declare([GanttWidget, _MaximoIO, Handlers], {
        ...
        _newTreeGridOptions: function () {
            var me = this;
            var options = {
                    Data: {Url: me.toUrl('async_load_compare_pages', me._ioOptions({compare: this.compareData})), Timeout: 300, Format: 'JSON', Method: 'POST'},
                    Page: {Url: me.toUrl('async_load_compare_page', me._ioOptions({compare: this.compareData})), Timeout: 300, Format: 'JSON', Method: 'POST'},
                    Layout: {
