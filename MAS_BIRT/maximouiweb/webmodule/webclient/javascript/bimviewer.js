...
/**********************************************************************/
	function SelectionManager( 
		...
		{
			console.log("selectionmanager updateSelectionSet: " + ctrl);
			...
			console.log("selectionmanager updateSelectionSet before onChange: " + this.selection);
	...
	function maximoInterface(
		...
		this.maxMultiSelect = function( selectionList, selection )
		{
			...
			console.log("maximoInterface maxMultiSelect: " + curMultiSelect);
			maxMultiSelectDelay();
		}
