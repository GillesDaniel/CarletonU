...
function newDatasource(data = tktemp, name = 'tktemplateds') {
  ...
  it("TKTemplateController", async () => {
    ...
    const ds = newDatasource(tktemp, 'tktemplateds');	
  ...
  it("gotoDetails", async () => {
    ...
    await ds.load();    
    app.datasources.tktemplateds.toggleSelected(0);
    var viewindex = app.datasources.tktemplateds.getSelectedItems()[0].description;
  ...
  it("backFromCreateSR", async () => {
    ...
    app.state.pagelist = [{pagename: "tktemp"}];
