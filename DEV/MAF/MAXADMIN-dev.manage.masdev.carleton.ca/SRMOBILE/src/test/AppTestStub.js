...
import SubCategoryDataController from '../SubCategoryDataController';
...
import dataSRListds from '../sr-attributes-list.js';
...
const DialogCreateSrLongInstructionsDialog = ()=>'';
const DialogCreateSrDescriptionDialog = ()=>'';
...
const appInitialize = async (setAppInst, bootstrapInspector) => {
  ...
  refreshDelay: 0,
  query:   {
    select: `ticketid,ticketuid,assetnum,location,description,description_longdescription,computedSRStatusPriority,computedSRDescription,computedWorklogCount,computedDoclinksCount,status_description,reportedpriority_description,href,record,transaction`,
    src: ([])
  },
  autoSave: false,
  ...
  configuration:   {
    ...
    return (
      ...
      page = bootstrapInspector.onNewPage(new Page(bootstrapInspector.onNewPageOptions({name:'srDetails', clearStack: false, parent: app, route: '/srDetails/*', title: app.getLocalizedLabel("srDetails_title", "srDetails"), usageId: undefined, contextId: undefined})));
  ...
  configuration:   {
    ...
    appResolver: (() => app)
      ...
      page.addInitializer(
      (page, app) => {
        page.setState(bootstrapInspector.onNewState({"splitViewIndex":0,"contactrequiredState":false,"detailrequiredState":false,"locationrequiredState":false,"assetrequiredState":false,"addressrequiredState":false,"contactdetail":"","contactdetails":"","lastcategorydesc":"","ishighpriority":false,"siteid":"","srdescription":"","location":"","locationdesc":"","assetnum":"","assetdesc":"","assetwhere":"","formattedaddress":"","streetaddress":"","city":"","stateprovince":"","latitudey":"","longitudex":"","mapIsForAsset":false,"mapSelectDisabled":true,"mapValueSelected":"","newTicketSpecSRC":"{[]}","useConfirmDialog":true,"assetlocationmismatch":false,"hasInvalidAsset":false,"hasInvalidLocation":false,"canLoad":{"page":false,"locationJsonMap":false,"locationMap":false,"assetJsonMap":false,"assetMap":false},"captureCoordinatesInProg":false,"isAssetEditEnabled":false,"spatialRefs":{"ASSET":"EPSG:4326","LOCATION":"EPSG:4326","BASEMAP":"EPSG:3857"},"isRequired":{"description":false,"description_longdescription":false,"affectedperson":false,"affectedphone":false,"affectedemail":false,"assetnum":false,"location":false,"formattedaddress":false,"streetaddress":false,"city":false,"stateprovince":false}}, 'page'), {});
...
`department`
  ...
  schemaExt:   [
    ...
    {
      name: `computedValue`,
      'computed-function': `computedValue`,
      id: `p9d53`,
      computed: (true),
      local: (true)
    }
  ...
  computedFields:   {
    computedValue:     {
      computedFunction: ((item, datasource) => datasource.callController('computedValue', item))
    }
  },
  notifyWhenParentLoads: true,
  appResolver: (() => app),
  ...
  autoLoadRef:   [
                  ...
                  let ds = bootstrapInspector.onNewDatasource(new Datasource(da, options), da, options);
                  let controller = new PersonDataController();
bootstrapInspector.onNewController(controller, 'PersonDataController', ds);
...
`orgid`
  ...
  notifyWhenParentLoads: true,
  appResolver: (() => app),
  canLoad: (()=>(page.state.canLoad.locationMap)),
  clearSelectionOnSearch: true,
  watch:   [
...
`description`
    ...
    select: `_id,locationsid,location,description,status_maxvalue,autolocate,distance,latitudey,longitudex,mapsketch`,
    src: ([])
  },
  autoSave: false,
  selectionMode: `single`,
  ...
  debounceTime: 0,
  appResolver: (() => app),
  canLoad: (()=>(page.state.canLoad.locationJsonMap)),
  clearSelectionOnSearch: true,
  watch:   [
...
`serviceaddress.formattedaddress--formattedaddress`
    ...
    select: `itemnum,assetuid,assetnum,description,assethealth,assettag,assettype,binnum,itemnum,location,location.description--locationdesc,manufacturer,priority,serialnum,siteid,vendor,autolocate,parent,status,serviceaddress.formattedaddress--formattedaddress,serviceaddress.latitudey,serviceaddress.longitudex,rel.mapsketch{sketchList,sketchname,mapsketchid}`
  },
  objectStructure: `MXAPIASSET`,
...
`serviceaddress.formattedaddress--formattedaddress`
  ...
  notifyWhenParentLoads: true,
  appResolver: (() => app),
  canLoad: (()=>(page.state.canLoad.assetMap)),
  clearSelectionOnSearch: true,
  watch:   [
...
`description`
    ...
    select: `_id,assetuid,assetnum,description,status_maxvalue,autolocate,distance,location,locationdesc,latitudey,longitudex,mapsketch`,
    src: ([])
  },
  autoSave: false,
  selectionMode: `single`,
  ...
  debounceTime: 0,
  appResolver: (() => app),
  canLoad: (()=>(page.state.canLoad.assetJsonMap)),
  clearSelectionOnSearch: true,
  watch:   [
...
ds.registerController(controller);
  ...
  query:   {
    ...
    select: `ticketid,ticketspecid,section,templateid,tktemplatespecid,assetattrid,assetattrid_description,assetattribute.description,classstructureid,refobjectid,refobjectname,mandatory,displaysequence,alnvalue,numvalue,tablevalue,datevalue,assetattributedesc,assetattributedatatype,assetattributedatatype_maxvalue,assetattributedomainid`,
  ...
  configuration:   {
    ...
    return (
      <DialogSysMsgLocationMismatchDialog id={"sysMsgLocationMismatchDialog_dlg_container"} datasource={props.datasource || undefined} item={props.item} key={props.key||props.id} onClose={props.onClose} zIndex={props.zIndex} callback={props.callback}/>
                ...
                // begin dialog - createSrLongInstructionsDialog
                /* eslint-disable no-lone-blocks */
                {
                  let options = {
  name: `createSrLongInstructionsDialog`,
  configuration:   {
    id: `createSrLongInstructionsDialog`,
    dialogRenderer: ((props => {
    return (
      <DialogCreateSrLongInstructionsDialog id={"createSrLongInstructionsDialog_dlg_container"} datasource={props.datasource || undefined} item={props.item} key={props.key||props.id} onClose={props.onClose} zIndex={props.zIndex} callback={props.callback}/>
    );
  })
  )
  }
                ...
                // end dialog - createSrLongInstructionsDialog
                

                // begin dialog - createSrDescriptionDialog
                /* eslint-disable no-lone-blocks */
                {
                  let options = {
  name: `createSrDescriptionDialog`,
  configuration:   {
    id: `createSrDescriptionDialog`,
    dialogRenderer: ((props => {
    return (
      <DialogCreateSrDescriptionDialog id={"createSrDescriptionDialog_dlg_container"} datasource={props.datasource || undefined} item={props.item} key={props.key||props.id} onClose={props.onClose} zIndex={props.zIndex} callback={props.callback}/>
    );
  })
  )
  }
                ...
                // end dialog - createSrDescriptionDialog
...
`orgid`
  ...
  autoLoadRef:   [
                ...
                // begin datasource - alndomainValidationDS
                {
                  let options = {
  platform: `maximoMobile`,
  name: `alndomainValidationDS`,
  datasourceLocator: ((dataSourceName) => app.findDatasource(dataSourceName)),
  pageSize: 50,
  debounceTime: 100,
  query:   {
...
`orgid`
  ...
  autoLoadRef:   [
                ...
                // end datasource - alndomainValidationDS
...
`description`
  ...
  autoLoadRef:   [
                ...
                // begin datasource - numericDomainValidationDS
                {
                  let options = {
  platform: `maximoMobile`,
  name: `numericDomainValidationDS`,
  datasourceLocator: ((dataSourceName) => app.findDatasource(dataSourceName)),
  pageSize: 10,
  debounceTime: 100,
  query:   {
...
`description`
  ...
  parentDatasource: `numericDomainDS`,
  computedFields:   {
  ...
  autoLoadRef:   [
                ...
                // end datasource - numericDomainValidationDS
...
`templateid`
  ...
  notifyWhenParentLoads: true,
  appResolver: (() => app),
  canLoad: (()=>(app.state.canLoad.tktemplate)),
  clearSelectionOnSearch: true,
  watch:   [
...
`classusewithsr._exists--usewithsr`
    ...
    select: `classificationid,classificationdesc,classstructureid,description,sortorder,_id,_imagelibref,siteid,orgid,parent,rel.classusewith{objectname},classusewithsr._exists--usewithsr,mobilechildsr._exists--hassubcategory,mobiletktemplate._exists--hasactivetype`
  },
  objectStructure: `mxapitkclass`,
  ...
  schemaExt:   [
    ...
    {
      name: `displayIcon`,
      'computed-function': `calculateDisplayIcon`,
      id: `ad68d`,
      computed: (true),
      local: (true)
    },
    ...
    {
      name: `mobilechildsr._exists--hassubcategory`,
      id: `qk8wq`
    },
    {
      name: `mobiletktemplate._exists--hasactivetype`,
      id: `jm4rr`
    }
  ],
  qbeAttributes:   [
  ...
  computedFields:   {
    displayIcon:     {
      computedFunction: ((item, datasource) => datasource.callController('calculateDisplayIcon', item))
    }
  },
  notifyWhenParentLoads: true,
  appResolver: (() => app),
...
`classusewithsr._exists--usewithsr`
  ...
  autoLoadRef:   [
                  ...
                  let da = bootstrapInspector.onNewDataAdapter(platform.newMaximoDataAdapter(options,app.client.restclient), options, 'AutoMaximoDataAdapter');
                  let ds = bootstrapInspector.onNewDatasource(new Datasource(da, options), da, options);
                  let controller = new SubCategoryDataController();
bootstrapInspector.onNewController(controller, 'SubCategoryDataController', ds);
ds.registerController(controller);
...
ds.registerController(controller);
  ...
  query:   {
    ...
    notifyWhenParentLoads: true,
    cacheExpiryMs: 10000,
    select: `refobjectid,ticketspecid,assetattrid,assetattribute.description--assetattributedesc,assetattribute.datatype--assetattributedatatype,assetattribute.domainid--assetattributedomainid,alnvalue,numvalue,tablevalue,datevalue,section,anywhererefid`,
    dsParentObject: `mxapisr`
  },
  objectStructure: `mxapisr`,
  idAttribute: `ticketspecid`,
  ...
  schemaExt:   [
    ...
    {
      name: `assetattribute.datatype--assetattributedatatype`,
      id: `j2m6z`
    },
    {
      name: `assetattribute.domainid--assetattributedomainid`,
      id: `ww7zv`
    },
    {
      name: `alnvalue`,
  ...
  query:   {
    ...
    notifyWhenParentLoads: true,
    cacheExpiryMs: 10000,
    select: `personid,displayname,_imagelibref,_id`,
    dsParentObject: `mxapisr`
  },
  objectStructure: `mxapisr`,
  idAttribute: `_id`,
