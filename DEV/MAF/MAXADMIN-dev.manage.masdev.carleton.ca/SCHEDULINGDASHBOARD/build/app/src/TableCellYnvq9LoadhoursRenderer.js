...
const TableCellYnvq9LoadhoursRenderer = observer(props => {
    const app = props.app;
...
const jOptimizeSummaryDS = props.jOptimizeSummaryDS || app.findDatasource("jOptimizeSummaryDS");
    ...
    datacomponentoriginalid={"pdn2_"}
    datacomponenttype={"box"}
    datadraggable={"true"}
    droppable={"true"}
    
  >
<DatasourceLabel  theme={"field"} label={app.format((item?item.loadhours:undefined),'loadhours',null,datasource)} spacing={"none"} padding={"none"} id={'g39xx[' + props.rowId + ']'} datadraggable={"true"} datacomponenttype={"label"} datacomponentoriginalid={"g39xx"} datasource={datasource} item={item} field={"loadhours"}></DatasourceLabel>
</Box>
...
export default inject('app')(TableCellYnvq9LoadhoursRenderer);
