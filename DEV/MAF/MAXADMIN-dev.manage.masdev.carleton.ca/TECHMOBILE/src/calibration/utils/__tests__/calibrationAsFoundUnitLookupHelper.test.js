...
const baseSetup = async () => {
    initializeApp = newTestStub({
        ...
        datasources: {
            pluscWoDs: {
                data: require("../../test/test-calibration-data.js"),
            },
            unitspointLookupDs: {
                data: require("../../test/test-calibration-unit.js")
            }
        },
    });
...
describe("Calibration As Found Unit Lookup Helper", () => {
    ...
    describe("openUnitLookup",  () => {
        it("Dialog 'unitspointLookup' is shown when opening unit lookup", async () => {
            ...
            const helper = new UnitLookupHelper(app, page, 'unitspointLookupDs', 'unitspointLookup');
