...
This will start a React development server (usually on port 3000) and then open your default web browser.
...
## Dealing with CORS issues in the Manage Shell

In Maximo, update the 2 system properties

```
maximo_extended_host='localhost'
maximo_extended_host_port='3000'
```

This will allow the iframe to load without CORS issues.