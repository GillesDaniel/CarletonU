...
import issuetypeDomainData from "./test/issuetype-domain-data";
import matrectransitem from "./test/matrectrans-json-data";
...
it("PO List page loads empty", async () => {
  ...
  synonymdomainDS_issueType.registerController(poListController);
...
it("PO List page loads in browser", async () => {
  ...
  sinon.stub(matrectransDs, "load").returns(matrectransitem.member);
  sinon.stub(matrectransDs, "getItems").returns(matrectransitem.member);
  sinon.stub(poListController, "getDatasourceCopy").returns(dspolist);
  ...
  poListController.onAfterLoadData(dspolist, polistitem.member);
...
it("PO List page loads in mobile", async () => {
  ...
  poListController.gotoDetailActionPage(event);
  poListController.dataCache["receiptpage"] = {};
